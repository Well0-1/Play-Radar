...
export default function Main() {
  ...
  return (
    <div className="w-full min-h-screen relative flex flex-col max-2xl:pb-4 2xl:p-[2%] bg-gradient-to-b from-slate-800 to-slate-900">
      <div className="w-full flex lg:justify-between lg:p-4 pb-3">
        <div className="flex items-center justify-center max-lg:hidden pl-5">
      ...
      <div className="sm:grid flex flex-col max-sm:space-y-4 place-items-center grid-cols-4 max-2xl:px-2 gap-4 max-2xl:grid-cols-3 max-lg:grid-cols-2 max-sm:gap-0 text-white">
